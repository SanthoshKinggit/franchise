                  ...
                  decoration: InputDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                      ...
                      borderSide: BorderSide(
                          color: const Color.fromARGB(255, 242, 235, 245),
                          width: 1.0), // Border when not focused
                    ),
                    focusedBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(15.0),
                      borderSide: BorderSide(
                          color: const Color.fromARGB(255, 229, 204, 241),
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => RestaurantDetailPage(image: '', shopName: '',
                ...
                child: Container(
                  ...
                  child: Stack(
                    clipBehavior: Clip
                        .none, // Allow the image to go outside the container bounds
                    children: [
                    ...
                    children: [
                      Container(
                          ...
                          child: ImageIcon(AssetImage(
                              "assets/images/service/filtericon.png"))),
                      ...
                      SizedBox(width: 8.0),
                      buildFilterButton(
                          'Others', false), // Add more filters if needed
                    ],
                  ),
                ),
              ),
  ...
  Widget buildFilterButton(String label, bool isSelected) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: isSelected
            ? [
                BoxShadow(
                  color:
                      const Color.fromARGB(255, 195, 0, 255).withOpacity(0.3),
      ...
      child: Row(
        children: [
          if (isSelected)
            Icon(Icons.check, size: 16, color: Colors.white), // Optional icon
