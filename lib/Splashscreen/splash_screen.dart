...
class FranchiseParticlePainter extends CustomPainter {
  final math.Random random;
  FranchiseParticlePainter({required this.random});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final particleCount =
        random.nextInt(5) + 5; // Random particle count per draw
    for (int i = 0; i < particleCount; i++) {
      final x = random.nextDouble() * size.width;
      final y = random.nextDouble() * size.height;
      final radius = random.nextDouble() * 3 + 2; // Random radius for particles
